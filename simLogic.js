        ...
        // DOM Listeners
        const modes = ['flat', 'concave', 'convex', 'prism', 'freehand', 'moveLight', 'moveObj', 'toggleTwoSided'];
                    ...
                    for (let b = 0; b <= maxBounces; b++) {
                        ...
                        if (bestHit) {
                            ...
                            if (bestHit.isBack && !bestHit.m.twoSided) {
                                // Absorbed by the non-reflective side
                                break;
                            }
                            ...
                            if (showNormals) {
                                ...
                                // Calculate angle theta (acos of dot product of incident ray and normal)
